...
const NavigationBar = () => {
  ...
  const closeDrawerRight = () => setOpenRight(false);
    ...
    return (
        <>
          <Navbar className='py-3 bg-white' shouldHideOnScroll>
    ...
    <img className='w-6 md:hidden' onClick={openDrawerRight} src={hamBurger} alt="" />
    </>
      ...
      <Drawer placement="right" open={openRight} onClose={closeDrawerRight} className="p-0 w-[320px]">
      <div className="mb-2 bg-[#0397d3] text-white py-[10px] px-3 flex items-center justify-between gap-1">
        <div className='flex items-center gap-1'>
        <FaHome className='w-5 h-4'></FaHome>
      ...
      <div>
      <Link className="block text-lg px-2 font-normal hover:text-sky-600 py-[5px]" to={'/my-section/profile'}>My Account</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myOrders'}>My Orders</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/downloadFreeBook'}>Download Free Book</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myEbook'}>My eBook Library</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myList'}>My List</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/bookShelf'}>My Book Shelf</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myWishlish'}>My Wishlist</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myRatingReviews'}>My Rating Reviews</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myPoints'}>My Points</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myFollowedAuthors'}>My Following Authors</Link>
<Link className="block text-lg px-2 font-normal hover:text-sky-600 py-3" to={'/myBkashAccount'}>My Bkash Account</Link>
      </div>
      </Drawer>
          </>
    );
