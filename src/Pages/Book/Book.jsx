...
const Book = () => {
    ...
    const [irons, isIronsLoading] = UseProductsBySecondaryCategory({category: "iron"});
    const [refrigerators, isRefrigeratorsLoading2] = UseProductsBySecondaryCategory({category: "refrigerator"});
    const [kettles, isKettlesLoading2] = UseProductsBySecondaryCategory({category: "kettle"});
    const [airCollers, isAirCollersLoading2] = UseProductsBySecondaryCategory({category: "airColler"});
    const [televisons, isTelevisonsLoading2] = UseProductsBySecondaryCategory({category: "television"});
    ...
    return (
        <div>
            ...
            <SecondaryProductContainer data={refrigerators} apiPath={"products"} headding={"Refrigerator are on fire 🔥🔥"}></SecondaryProductContainer>
            <SecondaryProductContainer data={kettles} apiPath={"products"} headding={"Buy The Hot kettles "}></SecondaryProductContainer>
            <SecondaryProductContainer data={airCollers} apiPath={"products"} headding={"Buy AirCollers to cool down ⛄⛄"}></SecondaryProductContainer>
            <SecondaryProductContainer data={televisons} apiPath={"products"} headding={"See Movies in Big Screens"}></SecondaryProductContainer>
        </div>
    );
};
